...
// Long enough to overflow the card at the 15.5px base size and force useFitText to
// walk the size down (measured: 15.5px → 13.5px in this pane). The fixture's own
// steps all fit without shrinking, which is why this one is local — the shrink
// path only exists because scraped recipes really do have steps this size. Keeps a
